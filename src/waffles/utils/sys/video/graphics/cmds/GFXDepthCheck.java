...
/**
 * The {@code GFXDepthCheck} interface defines depth check options for {@code GFXGraphics}.
 ...
 * @see Resettable
 */
public interface GFXDepthCheck extends Resettable
{
	/**
	...
	/**
	 * Changes the writeability of the {@code GFXDepthCheck}.
	 * 
	...
	/**
	 * Changes the bound values of the {@code GFXDepthCheck}.
	...
	/**
	 * Changes the method of the {@code GFXDepthCheck}.
	 * 
	...
	/**
	 * Clears the buffer of the {@code GFXDepthCheck}.
	 * 
