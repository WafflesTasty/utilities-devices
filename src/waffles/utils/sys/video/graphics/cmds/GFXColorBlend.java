...
/**
 * The {@code GFXColorBlend} interface defines blending options for {@code GFXGraphics}.
 ...
 * @see Resettable
 */
public interface GFXColorBlend extends Resettable
{
	/**
	...
	/**
	 * Enables standard {@code GFXColorBlend}.
	 */
	...
	/**
	 * Changes the method of the {@code GFXColorBlend}.
	 * 
	...
	/**
	 * Changes the alpha method of the {@code GFXColorBlend}.
	 * 
	 * @param method  a blending method
	 * @param src  a source factor
	 * @param dst  a destination factor
	...
	/**
	 * Changes the color method of the {@code GFXColorBlend}.
	 * 
	 * @param method  a blending method
	 * @param src  a source factor
	 * @param dst  a destination factor
	...
	/**
	 * Changes the color of the {@code GFXColorBlend}.
	 * 
